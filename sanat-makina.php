...
$datas_tr = [
    ...
    "musteri" => "Sanat Makina",
    "tarih_dil"=>"Proje Tarihi",
    "tarih" => "10 Nisan, 2022",
    "url" => "www.sanatmakina.com",
    "url_dil"=>"Proje Linki",
    "aciklama" => "Proje kapsamında websitesi oluşturulması,
     seo uyumlu hale getirilmesi ve içeriğinin oluşturulması
     sağlanmıştır. Düzenli güncelleme ve anahtar kelime çalışması
     ile google üst sıralarında yer alması başarılmıştır. ",
...
$datas_en = [
    ...
    "url" => "www.sanatmakina.com",
    "aciklama" => "Within the scope of the project, a website was created,
     made seo compatible and its content was created. With regular updates and keyword work,
     it has been ensured that it is in the top ranks of google.",
                    ...
                    <div class="portfolio-details-slider swiper">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/portfolio/sanat_makina_1.png" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/portfolio/sanat_makina_2.png" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/portfolio/sanat_makina_3.png" alt="">
                            </div>
