...
<head>
    ...
    <title>Baygun hırdavat</title> <!--TODO BURASI DİNAMİK OLACAK-->
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Baygun Panel</span>
                </a>
        ...
        <div class="layout-page">
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"> Ayarlar</h4>
                    <hr class="my-5"/>
                    <div class="d-flex flex-wrap" id="icons-container">
                        <div class="card icon-card cursor-pointer text-center mb-4 mx-2">
                            <div class="card-body">
                                <a href="kisi_ayarlari/kisi_ayarlari.php">
                                    <i class="bx bxs-group mb-2"></i>
                                    <p class="icon-name text-capitalize text-truncate mb-0">Kişi Ayarları</p>
                                </a>
                            </div>
                        </div>
                    </div>
